...
import Project from "https://framer.com/m/Project-CZCy.js@nhP1GpYfOCnyCBJwR8BH"
		...
		<ClientOnly>
			{
				data.projects.map(project => {
					return <Project style={{ marginLeft: "auto", marginRight: "auto", marginBottom: "1.5rem" }} {...project} />
				})
			}
		</ClientOnly>
	);
